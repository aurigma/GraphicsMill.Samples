...
namespace Main
{
	public class FormMain : System.Windows.Forms.Form
	{
		...
		[System.Diagnostics.DebuggerStepThrough()]private void InitializeComponent()
		{
			...
			this.imageListToolbarIcons.Images.SetKeyName(0, "");
			this.imageListToolbarIcons.Images.SetKeyName(1, "");
			this.imageListToolbarIcons.Images.SetKeyName(2, "");
			this.imageListToolbarIcons.Images.SetKeyName(3, "");
			this.imageListToolbarIcons.Images.SetKeyName(4, "");
			this.imageListToolbarIcons.Images.SetKeyName(5, "");
			this.imageListToolbarIcons.Images.SetKeyName(6, "");
			this.imageListToolbarIcons.Images.SetKeyName(7, "");
			this.imageListToolbarIcons.Images.SetKeyName(8, "");
			this.imageListToolbarIcons.Images.SetKeyName(9, "");
			this.imageListToolbarIcons.Images.SetKeyName(10, "");
			this.imageListToolbarIcons.Images.SetKeyName(11, "");
			this.imageListToolbarIcons.Images.SetKeyName(12, "");
			this.imageListToolbarIcons.Images.SetKeyName(13, "");
			this.imageListToolbarIcons.Images.SetKeyName(14, "");
			this.imageListToolbarIcons.Images.SetKeyName(15, "");
			// 
        ...
        void bitmapViewerMainView_ContentChanged(object sender, EventArgs e)
        {
        ...
        void bitmapViewerMainView_MouseWheel(object sender, System.Windows.Forms.MouseEventArgs e)
        {
            if (bitmapViewerMainView.ZoomMode != ZoomMode.None)
                bitmapViewerMainView.ZoomMode = ZoomMode.None;
        }
...
// 			Cylindrize _cylindrize = new Cylindrize();
// 			CylindrizeToolStripMenuItem.Enabled = _cylindrize.IsPixelFormatSupported(bitmapViewerMainView.Bitmap.PixelFormat);
// 			_cylindrize.Dispose();
