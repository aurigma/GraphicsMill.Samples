...
class PDFAndEPSOutputExample
{
	...
	public static void GenerateRgbPdf()
	{
		...
		using (var pdfWriter = new PdfWriter("../../../../Output/PDFAndEPSOutput.pdf"))
		{
			...
			using (var graphics = pdfWriter.GetGraphics())
			{
				...
				//Image
				using (var bitmap = new Bitmap("../../../../Input/Chicago.jpg"))
				{
	...
	public static void GenerateCmykEps()
	{
		...
		using (var epsWriter = new EpsWriter("../../../../Output/PDFAndEPSOutput.eps", UnitConverter.ConvertUnitsToPixels(dpi, 3.5f, Unit.Inch),
